...
BoxItem.prototype.isVisible = function(range) {
  ...
  if (align == "right") {
    isVisible =
      this.data.start > range.start && this.data.start - widthInMs < range.end;
  } else if (align == "left") {
    isVisible =
      this.data.start + widthInMs > range.start && this.data.start < range.end;
  } else {
    // default or 'center'
    isVisible =
      this.data.start + widthInMs / 2 > range.start &&
      this.data.start - widthInMs / 2 < range.end;
  }
  return isVisible;
};
